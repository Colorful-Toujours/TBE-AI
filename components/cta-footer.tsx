...
const footerLinks = {
  研究: ["技术博客", "白皮书", "开放平台"],
  产品: ["智能记账", "发票中心", "TBE Agent", "语音记账"],
  开放平台: ["API 文档", "开发者社区", "SDK 下载"],
  关于我们: ["公司介绍", "加入我们", "联系我们", "合作伙伴"],
  新闻动态: ["产品更新", "媒体报道", "活动信息"],
}
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-12">
          <div className="lg:w-1/3">
            <Link href="/" className="flex items-center gap-3 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white font-bold text-base">
                TBE
              </div>
            </Link>
